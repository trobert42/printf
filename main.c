...
/*   Updated: 2022/10/31 16:24:23 by trobert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf(" count2 = %d", printf("%"));
	...
	ft_printf(" count = %d", ft_printf("1 en x : %x,", hx));
	ft_printf("\n");
	printf(" count2 = %d", printf("2 en x : %x,", hx));
	printf("\n ---------------------------------------------------\n");

	ft_printf(" count = %d", ft_printf("1 en s : %s%s,", str));
	ft_printf("\n");
	printf(" count2 = %d", printf("2 en s : %s%s,", str));
	printf("\n ---------------------------------------------------\n");
